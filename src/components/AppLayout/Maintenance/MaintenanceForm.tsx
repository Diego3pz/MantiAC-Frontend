...
export default function MaintenanceForm({ register, errors, control }: MaintenanceFormProps) {
    ...
    return (
        <>
            ...
            <label className="block font-semibold text-slate-700" htmlFor="type">
                Tipo de mantenimiento
            </label>
            <select
                id="type"
                {...register("type", { required: "El tipo de mantenimiento es obligatorio" })}
                className="w-full border border-blue-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 bg-blue-50 transition"
            >
            ...
            {/* Fecha */}
            <label className="block font-semibold text-slate-700" htmlFor="date">
                Fecha
            </label>
            <input
                id="date"
            ...
            {type === "Correctivo" && (
                <>
                    {/* Descripción */}
                    <label className="block font-semibold text-slate-700" htmlFor="description">
                        Descripción
                    </label>
                    <textarea
                        id="description"
                    ...
                    <label className="block font-semibold text-slate-700" htmlFor="cost">
                        Costo
                    </label>
                    <input
                        id="cost"
            ...
            <label className="block font-semibold text-slate-700" htmlFor="performedBy">
                Técnico responsable
            </label>
            <input
                id="performedBy"
            ...
            <label className="block font-semibold text-slate-700" htmlFor="supervisedBy">
                Supervisor
            </label>
            <input
                id="supervisedBy"
